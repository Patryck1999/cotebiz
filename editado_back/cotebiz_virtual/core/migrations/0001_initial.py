# Generated by Django 2.2 on 2020-06-09 01:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('observacao_1', models.TextField(blank=True, null=True, verbose_name='Observação1')),
                ('observacao_2', models.TextField(blank=True, null=True, verbose_name='Observação2')),
                ('observacao_3', models.TextField(blank=True, null=True, verbose_name='Observação3')),
                ('observacao_4', models.TextField(blank=True, null=True, verbose_name='Observação4')),
                ('observacao_5', models.TextField(blank=True, null=True, verbose_name='Observação5')),
                ('observacao_6', models.TextField(blank=True, null=True, verbose_name='Observação6')),
                ('observacao_7', models.TextField(blank=True, null=True, verbose_name='Observação7')),
                ('observacao_8', models.TextField(blank=True, null=True, verbose_name='Observação8')),
                ('observacao_9', models.TextField(blank=True, null=True, verbose_name='Observação9')),
                ('observacao_10', models.TextField(blank=True, null=True, verbose_name='Observação10')),
                ('observacao_11', models.TextField(blank=True, null=True, verbose_name='Observação11')),
                ('observacao_12', models.TextField(blank=True, null=True, verbose_name='Observação12')),
                ('observacao_13', models.TextField(blank=True, null=True, verbose_name='Observação13')),
                ('observacao_14', models.TextField(blank=True, null=True, verbose_name='Observação14')),
                ('observacao_15', models.TextField(blank=True, null=True, verbose_name='Observação15')),
                ('observacao_16', models.TextField(blank=True, null=True, verbose_name='Observação16')),
                ('observacao_17', models.TextField(blank=True, null=True, verbose_name='Observação17')),
                ('observacao_18', models.TextField(blank=True, null=True, verbose_name='Observação18')),
                ('observacao_19', models.TextField(blank=True, null=True, verbose_name='Observação19')),
                ('observacao_20', models.TextField(blank=True, null=True, verbose_name='Observação20')),
            ],
            options={
