...
class Pedido_de_cotacao_clone(models.Model):
    data_agora = models.DateTimeField()
    n_pedido = models.CharField('Numero do pedido', max_length=10, null=True, blank=True)
    nome = models.CharField('Nome Fantasia', max_length=40)
    razao_social = models.CharField('Razão Social', max_length=80)
...
class Pedido_de_cotacao_fornecedor(models.Model):
    ...
    observacao_4 = models.TextField('Observação4', max_length=100, null=True, blank=True)
    observacao_5 = models.TextField('Observação5', max_length=100, null=True, blank=True)
    observacao_6 = models.TextField('Observação6', max_length=100, null=True, blank=True)
    observacao_7 = models.TextField('Observação7', max_length=100, null=True, blank=True)
    observacao_8 = models.TextField('Observação8', max_length=100, null=True, blank=True)
    observacao_9 = models.TextField('Observação9', max_length=100, null=True, blank=True)
    observacao_10 = models.TextField('Observação10', max_length=100, null=True, blank=True)
    observacao_11 = models.TextField('Observação11', max_length=100, null=True, blank=True)
    observacao_12 = models.TextField('Observação12', max_length=100, null=True, blank=True)
    observacao_13 = models.TextField('Observação13', max_length=100, null=True, blank=True)
    observacao_14 = models.TextField('Observação14', max_length=100, null=True, blank=True)
    observacao_15 = models.TextField('Observação15', max_length=100, null=True, blank=True)
    observacao_16 = models.TextField('Observação16', max_length=100, null=True, blank=True)
    observacao_17 = models.TextField('Observação17', max_length=100, null=True, blank=True)
    observacao_18 = models.TextField('Observação18', max_length=100, null=True, blank=True)
    observacao_19 = models.TextField('Observação19', max_length=100, null=True, blank=True)
    observacao_20 = models.TextField('Observação20', max_length=100, null=True, blank=True)
